...
def load_configurations(entrez_email,api_key,taxa_database_update='yes'):
    ...
    Returns:
    Configuration settings are provided - no files are created - if taxa database was "yes" new taxa could be added
    Example:
...
def scatterplot(accession_taxonomy_output, title_graph, filter_value=0):
    ...
    Returns:
        An interactive scatterplot to visualize features distribution
    """
...
def sunburst_plot(accession_taxonomy_output, title_graph, filter_value=0):
    ...
    Returns:
        An Interactive sunburst to visualize features distribution.
...
def taxonomyID_converter(text_search = None,file_search = None, input_type = 'O'):
    ...
    Returns:
        A tsv file with data conversions
